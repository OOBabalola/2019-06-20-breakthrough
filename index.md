...
carpentry: "FIXME"    # what kind of Carpentry ("dc").  
                      # Be sure to update the Carpentry type in _config.yml as well.  
venue: "FIXME"        # brief name of host site without address (e.g., "North-West University")
address: "FIXME"      # full street address of workshop (e.g., "Room G05, New Science building, Mmabatho, NWP")
country: "FIXME"      # lowercase two-letter ISO country code such as "za" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "FIXME"     # lowercase two-letter ISO language code such as "za" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "FIXME"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "FIXME"    # human-readable dates for the workshop (e.g., "June 20-21, 2019")
humantime: "FIXME"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: FIXME      # machine-readable start date for the workshop in YYYY-MM-DD format like 2019-06-20
enddate: FIXME        # machine-readable end date for the workshop in YYYY-MM-DD format like 2019-06-21
instructor: ["FIXME"] # boxed, comma-separated list of instructors' names as strings, like ["Olubukola Babalola"]
helper: ["FIXME"]     # boxed, comma-separated list of helpers' names, like ["Kenny Odelade"]
email: ["fixme@example.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["olubukola_babalola@yahoo.com"]
